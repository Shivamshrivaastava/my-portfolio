      ...
      <nav className="fixed top-0 w-full bg-white shadow-md z-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-16 items-center">
            <h1 className="text-2xl font-bold text-gray-800">Shivam Shrivastava</h1>
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-10">
            <div className="flex-1">
              ...
              <p className="text-lg text-gray-600 mb-6">
                Dynamic Full Stack Web Developer specializing in the MERN stack, adept in creating scalable web applications while leveraging strong problem-solving and collaboration skills. Committed to enhancing development workflows and maintaining software excellence.
              </p>
              <div className="flex gap-4">
                <a href="#contact" className="bg-blue-600 text-white px-6 py-3 rounded-lg hover:bg-blue-700 transition-colors">
                  Contact Me
                </a>
                <a href="#projects" className="border-2 border-blue-600 text-blue-600 px-6 py-3 rounded-lg hover:bg-blue-50 transition-colors">
                  View Projects
                </a>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            ...
            <div className="bg-gray-50 rounded-xl p-8 shadow-lg">
              ...
              <div className="flex flex-wrap gap-4">
                {['Problem Solving', 'Teamwork', 'Adaptability'].map((skill) => (
                  <span
                    key={skill}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-xl shadow-lg overflow-hidden">
              ...
              />
              <div className="p-6">
                <h3 className="text-xl font-bold mb-2">Social Media Analytics Platform</h3>
                <p className="text-gray-600 mb-4">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            >
              ...
              <span className="text-sm text-gray-500 mt-1">shivamshrivaastava@gmail.com</span>
            </a>
            <a
